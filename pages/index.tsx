      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .suggestion-chip {
          ...
          background: white; border: 1px solid rgba(148,163,184,.22);
        ...
        .error-banner {
          ...
          background: #fef2f2; border: 1px solid #fecaca; color: #b91c1c; font-size: 13.5px;
        }
        ...
        .input-wrapper {
          ...
          background: white; border-radius: 20px; padding: 8px 8px 8px 18px;
        ...
        .chat-input {
          ...
          font-size: 14.5px; font-family: inherit; background: transparent;
          color: #1e293b; line-height: 1.55; min-height: 24px; max-height: 160px; padding: 4px 0;
        }
        ...
        .send-active { background: linear-gradient(135deg, #6366f1, #7c3aed); color: white; box-shadow: 0 4px 12px rgba(99,102,241,.4); }
        .send-active:hover { transform: scale(1.07); }
        .send-disabled { background: #f1f5f9; color: #cbd5e1; cursor: not-allowed; }
        ...
        <header className="chat-header">
          <div className="header-inner">
            <div className="logo-group">
              ...
              <div>
                <p className="logo-title">Wizja AI</p>
        ...
        <main className="chat-main">
          {messages.length === 0 ? (
            <div className="welcome">
              ...
              <h1 className="welcome-title">Cześć! Jestem Wizja 👋</h1>
        ...
        <footer className="input-bar">
          <div className="input-inner">
            <div className="input-wrapper">
              ...
              />
              <button
                className={`send-btn ${loading || !input.trim() ? "send-disabled" : "send-active"}`}
